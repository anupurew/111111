...
//현재 날짜
let now = new Date();
console.log(now); // Mon Mar 04 2024 11:48:11 GMT+0900 (한국 표준시)
...
//Date 객체 메서드
//연, 월, 일 등의 값을 얻을수 있음
console.log(now.getFullYear()); //연도 4차리
...
console.log(Math.round(3.8)); //소수를 반올림하여 정수로 변환

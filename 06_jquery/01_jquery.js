...
function useAppend() {
  ...
  //after(): 선택된 요소의 두에 인자로 전달된 요소 추가(형제)
...
function useRemove() {
  ...
  //empty(): 선택된 요소의 모든 content삭제
  //container라는 class 가진 요소의 content(자식, 택스트 모두 )를 삭제
  $(".container").empty();
  //js는 empty없음 -> innerHTML 속성을 반 문자열로 하면 동일하게 기능
...
function controlClass() {
  ...
  //documnet.querySelector('#controlClass).classList.toggle('red);
}
